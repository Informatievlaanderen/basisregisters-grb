namespace Grb.Building.Tests.JobRecordProcessor
{
    ...
    public class GivenDemolishBuilding
    {
        [Fact]
        public async Task ThenDemolishBuildingRequestIsSent()
        {
            ...
            var jobRecord = new JobRecord
            {
                ...
                EventType = GrbEventType.DemolishBuilding,
            ...
            backOfficeApiProxy
                .Setup(x => x.DemolishBuilding(
                    jobRecord.GrId,
                    It.Is<DemolishBuildingRequest>(y => y.GrbData.Idn == jobRecord.Idn),
            ...
            //assert
            backOfficeApiProxy.Verify(x => x.DemolishBuilding(
                    jobRecord.GrId,
                    It.Is<DemolishBuildingRequest>(y => y.GrbData.Idn == jobRecord.Idn),
                    It.IsAny<CancellationToken>()),
                Times.Once);
